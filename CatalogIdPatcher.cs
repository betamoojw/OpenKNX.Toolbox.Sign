    ...
    class CatalogIdPatcher
    {
            ...
            int nsVersion)
        {
            ...
            if(lVersion >= new System.Version("6.2.0")) { //ab ETS6.2
                ...
                if(_type == null)
                    throw new Exception("Could not create CatalogIdPatcher");
        ...
        public void Patch()
        {
            if(_instance == null || _type == null)
                throw new Exception("Could not patch file. _instance or _type is null");
            MethodInfo? patch = _type.GetMethod("Patch", BindingFlags.Instance | BindingFlags.Public);
            if(patch == null)
                throw new Exception("Could not patch file. Patch method not found");
